...
class SwipeCardGestureTest {
    ...
    @Test
    fun swipeCard_DisplaysUserInfo() {
        ...
        // Verify the swipe card is displayed with the correct test tag
        composeRule.onNodeWithTag("swipe_card:${testUserA.userId}").assertIsDisplayed()
        
        // Verify profile info is displayed
        composeRule.onNodeWithTag("profile_info:${testUserA.userId}").assertIsDisplayed()
    }
    ...
    fun swipeRight_LikeAction_ProfileDisappearsAndNextProfileShows() {
        ...
        // In real implementation, next profile would be shown
    ...
    @Test
    fun swipeCard_SwipeLeft_TriggersOnSwipeLeft() {
        var swipeLeftTriggered = false
        
        composeRule.setContent {
            SwipeCard(
                modifier = Modifier.fillMaxSize(),
                user = testUserA,
                onSwipeLeft = { swipeLeftTriggered = true },
                onSwipeRight = {}
            )
        }
        ...
        // Note: In a real test, we would verify the swipe action completed
        // For now, we just verify the gesture can be performed without crashing
    }

    @Test
    fun swipeCard_SwipeRight_TriggersOnSwipeRight() {
        var swipeRightTriggered = false
        ...
        composeRule.setContent {
            SwipeCard(
                ...
                user = testUserA,
                onSwipeLeft = {},
                onSwipeRight = { swipeRightTriggered = true }
            )
        }
