    ...
    Row(
        ...
        IconButton(
            ...
            Icon(
                ...
                tint = if (selected == "likeYou") Color.Red else Color.Black,
                modifier = Modifier.size(30.dp)
            )
        }
        ...
        IconButton(
            ...
            Icon(
                ...
                tint = if (selected == "message") Color.Red else Color.Black,
                modifier = Modifier.size(30.dp)
            )
        }
        ...
        IconButton(
            ...
            Icon(
                ...
                tint = if (selected == "profile") Color.Red else Color.Black,
                modifier = Modifier.size(30.dp)
            )
        }
    }
